...
# bash scripts/train_policy.sh instr_dp3 calvin_multi_task 0720 0 0
...
export PYTHONPATH=/data/sea_disk0/zhangxx/3DDA_DP3
...
#     --calvin_gripper_loc_bounds /home/tsungwek/repos/calvin/dataset/task_ABC_D/validation/statistics.yaml \
#     --save_video 1 \
#     --output_dir ${run_dir}
